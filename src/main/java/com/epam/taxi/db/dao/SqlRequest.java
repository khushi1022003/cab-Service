...
public class SqlRequest {
    ...
    public static final String GET_CAR_DESCRIPTION =
     ...
     public static final String GET_ORDER_PRICE =
    ...
    public static final String UPDATE_DISCOUNT_STATUS =
     ...
     public static final String INITIATE_BARGAINING =
            "INSERT INTO bargaining (order_id, proposed_fare, status) VALUES (?, ?, 'Pending')";

    public static final String UPDATE_ORDER_WITH_BARGAINING_DETAILS =
            "UPDATE `order` SET bargaining_status = ?, negotiated_fare = ?, negotiation_status = ? WHERE id = ?";

    public static final String GET_BARGAINING_DETAILS_FOR_ORDER =
            "SELECT bargaining_status AS status, negotiated_fare, negotiation_status FROM `order` WHERE id = ?";
